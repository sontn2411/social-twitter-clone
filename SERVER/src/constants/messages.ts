const USER_MESSAGES = {
  ...
  USERNAME_LENGTH: 'Username length must be from 1 to 200',
  IMAGE_MUST_BE_STRING: 'Images must be a string',
  IMAGE_LENGTH: 'Images length must be from 1 to 500',
  ...
  INVALID_FOLLOWED_USER_ID: 'Invalid lollowed user ID',
  ALREADY_FOLLOW: 'Already follow',
  ALREADY_UNFOLLOW: 'Already unfollow',
  USERNAME_EXITED: 'Username exited',
  USERNAME_INVALID:
